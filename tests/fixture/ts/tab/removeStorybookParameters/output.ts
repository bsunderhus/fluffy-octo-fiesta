 ...
 */ export function removeStorybookParameters(babel: typeof Babel): Babel.PluginObj<{
		foundExports: number;
}> {
		return {
				name: PLUGIN_NAME,
				...
				post (file) {
						if (this.foundExports > 1) {
								console.warn("\n\x1b[33m%s\x1b[0m", `WARNING: This file has multiple exports, please fix (${this.foundExports}):
${file.opts.filename}
