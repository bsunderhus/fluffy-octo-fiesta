...
export function always<Props extends UnknownSlotProps>(
  ...
  if (props && typeof props.children === "function") {
    propsWithMetadata[SLOT_RENDER_FUNCTION_SYMBOL] =
      props.children as SlotRenderFunction<Props>;
...
export function resolveShorthand<
  Props extends UnknownSlotProps | null | undefined
>(value: Props | SlotShorthandValue): Props {
  if (
    typeof value === "string" ||
    typeof value === "number" ||
    Array.isArray(value) ||
